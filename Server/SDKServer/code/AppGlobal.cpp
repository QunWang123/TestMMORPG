...
namespace app
{
	...
	net::ITCPServer* __TcpCenter = nullptr;
	http::HttpServer*  __HttpServer = nullptr;
...
// 
// 		io::pushLog(io::EFT_ERR, "security connet...%d [%s:%d][connect:%d-%d] [clientid:%d-%s] [memory:%.4f/%.4f]\n",
// 			(int)c->socketfd, c->ip, c->port, aa, bb, c->clientID, type.c_str(), curmemory1, maxmemory1);
	}
	//主线程
